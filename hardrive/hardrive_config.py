...
config[PROJECT_DIRECTORY] = config[SRC_DIRECTORY] + "hardrive"
...
config[LOGGING_FILE_NAME] = config[BASE_PATH] + "/log/hardrive.log"

config[LOGGING_TEST_FILE_NAME] = '/home/pi/test/logs/hardrive-test.log'
